...
/** '''O1Library''' is a toolkit designed for the course [[https://plus.cs.aalto.fi/o1/2019/
 ...
 *  for playing sound.
  ...
  *
  * O1Library has been developed by Aleksi Lukkarinen and Juha Sorva. Several of
  * the key components in `o1.gui` and `o1.world` are built upon Aleksi’s
  ...
  *
  * We are grateful to Riku Autio, Joonatan Honkamaa, Juhani Numminen, and anonymous students
  * for bug reports and fixes. We thank Otto Seppälä for helpful discussions.
  *
