...
package object gui {
  ...
  private[o1] implicit class ConvenientLabel(val self: scala.swing.Label) extends AnyVal {
    ...
    def icon_=(newIcon: Option[Icon]): Unit = {
      self.icon = newIcon.orNull
    }
  }

  private[gui] val O1LogoPic: Option[Pic] = Pic.asOption("o1.png")
  private[gui] val O1LogoImage: Option[java.awt.Image] = O1LogoPic.flatMap( _.toImage )
  private val EmptyImage: Option[java.awt.Image] = Pic.asOption("nothing.png").flatMap( _.toImage )
